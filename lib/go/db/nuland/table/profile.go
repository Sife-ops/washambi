...
func newProfileTableImpl(schemaName, tableName, alias string) profileTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, DomainIDColumn, IndexColumn, NameColumn, CreatedAtColumn, DeletedAtColumn}
		mutableColumns  = postgres.ColumnList{DomainIDColumn, IndexColumn, NameColumn, CreatedAtColumn, DeletedAtColumn}
	)
